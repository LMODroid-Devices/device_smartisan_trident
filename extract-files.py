...
blob_fixups: blob_fixups_user_type = {
    ...
    ('vendor/lib64/vendor.goodix.hardware.fingerprintextension@1.0.so', 'vendor/lib64/com.fingerprints.extension@1.0.so', 'vendor/lib64/com.novatek.fingerprint@1.0_vendor.so', 'vendor/bin/hw/android.hardware.biometrics.fpcfingerprint@2.1-service', 'vendor/bin/hw/android.hardware.biometrics.goodixfingerprint@2.1-service', 'vendor/bin/hw/android.hardware.biometrics.nvtfingerprint@2.1-service'): blob_fixup()
